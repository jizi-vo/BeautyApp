...
import com.example.BeautyApp.adapters.AdminLoaiMyPhamAdapter;
...
public class LoaiMonActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static AdminLoaiMyPhamAdapter adminLoaiMonAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loai_mypham);
        ...
        adminLoaiMonAdapter = new AdminLoaiMyPhamAdapter(this,homeHorModelList);
    ...
    private void dialogAddCategory(int gravity) {
        ...
        dialog.setContentView(R.layout.dialog_mypham_add_category);
