...
import com.example.BeautyApp.activities.UpdateMonActivity;
import com.example.BeautyApp.admin.MonActivity;
...
public class AdminMyphamAdapter extends RecyclerView.Adapter<AdminMyphamAdapter.ViewHolder> {
    Context context;
    ...
    public AdminMyphamAdapter(Context context, List<ViewAllModel> viewAllModelList) {
...
//                openUpdateDialog(Gravity.BOTTOM,position);
    ...
    private void openUpdateDialog(int gravity,int position) {
        ...
        dialog.setContentView(R.layout.admin_dialog_mypham);
